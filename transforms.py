...
class VideoFolderPathToTensor(object):
    ...
    def __call__(self, path):
        ...
        file_names = sorted([f for f in os.listdir(path) if os.path.isfile(os.path.join(path, f))])
        ...
        frames = torch.FloatTensor(channels, num_time_steps, 160, 160)
