...
for phase in phases:
    path = os.path.join("C:\\Users\\urja\\Downloads\\Engagement_detection\\DAiSEE\\DataSet\\", phase)
    ...
    for subject in subjects:
        ...
        for video in videos:
            ...
            videoPathFrames = '\\'.join(videoPath.split('.')[0].split('\\')[:-1]).replace(phase, phase + 'Frames').replace("\\"+subject,"")
